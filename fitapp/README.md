...
- realizację treningu krok po kroku (z licznikiem serii i odpoczynków),
...
**ExerciseDB API**  
Dokumentacja:  
https://v2.exercisedb.dev/docs#tag/liveness

Używane endpointy:
- `/api/v1/exercises` — lista ćwiczeń (z paginacją cursorową)
